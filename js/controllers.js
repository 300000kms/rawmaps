...
angular.module('raw.controllers', [])
    ...
    .controller('RawCtrl', function ($scope, dataService, $http, $timeout, $sce) {
        ...
        //        $scope.$watch('charts', function ($scope) {
        //            for (c in $scope.charts) {
        //                console.log(c);
        //                console.log($scope.charts[c])
        //            }
        //        })
        //        for (var c in raw.charts.values()) {
        //            $scope.categories.push(raw.charts.values()[c].category())
        //        }
        ...
        //cada vez que cambiamos el mode se dispara esto...
